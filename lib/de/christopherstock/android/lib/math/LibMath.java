/*  $Id: LibMath.java 1176 2012-03-28 22:54:10Z jenetic.bytemare@gmail.com $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public abstract class LibMath
    {
        ...
        **************************************************************************************/
        ...
        public static final float getAngleCorrect( Point2f a, Point2f b ) {
        ...
        **************************************************************************************/
        ...
        public static Point2f getDistantPoint( Point3d src, float angle, float distance )
        {
            return new Point2f
            (
        ...
        public boolean isInRange( float ownX, float ownY, float otherX, float otherY, float max )
        {
            float dx = ownX - otherX;
            float dy = ownY - otherY;
