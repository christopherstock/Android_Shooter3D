/*  $Id: LibMathGeometry.java 1176 2012-03-28 22:54:10Z jenetic.bytemare@gmail.com $
 *  =======================================================================================
 */
    package de.christopherstock.android.lib.math;
    ...
    **************************************************************************************/
    public final class LibMathGeometry
    {
        ...
        **************************************************************************************/
/*
        public static Point2f findLineCircleIntersection( javax.vecmath.Vector2f line, javax.vecmath.Vector2f circle )
        {
            Point2f p1 = (Point2f)line.getP1();
            Point2f p2 = (Point2f)line.getP2();
            ...
            Point2f ret =
            (
                        line.getP1().distance( new Point2f( x1, y1 ) )
                    <   line.getP1().distance( new Point2f( x2, y2 ) )
                ?   new Point2f( x1, y1 )
                :   new Point2f( x2, y2 )
            );
...
*/
        ...
        **************************************************************************************/
/*
        public static Point2f findLineSegmentIntersection( Line2D.Float line1, Line2D.Float line2, LibDebug debug )
        {
            ...
            return new Point2f( (float)intersectionCoords[ 0 ], (float)intersectionCoords[ 1 ] );
...
*/
        ...
        **************************************************************************************/
        protected static int findLineSegmentIntersection
        (
            double x0, double y0,
            double x1, double y1,
            double x2, double y2,
