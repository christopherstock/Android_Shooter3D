/*  $Id: LibD3dsImporter.java 1176 2012-03-28 22:54:10Z jenetic.bytemare@gmail.com $
 *  =================================================================================
 */
    ...
    ********************************************************************************/
    public class LibD3dsImporter
    {
        ...
        *************************************************************************************/
        ...
        public      static  final   LibVertex           GLOBAL_ANCHOR               = new LibVertex( 0.0f, 0.0f, 0.0f );
        ...
        public LibD3dsImporter( String aFilename, LibDebug aDebug, Context aContext )
        {
            iFilename   = aFilename;
            iDebug      = aDebug;
            iContext    = aContext;
        ...
        private final String readAse()
        {
            try
            {
                byte[] bytes = LibFileManager.readFile( iFilename, iContext );
                ...
                BufferedReader  inStream    = new BufferedReader( new InputStreamReader( new ByteArrayInputStream( bytes ) ) );
