/*  $Id: LibStrings.java 1176 2012-03-28 22:54:10Z jenetic.bytemare@gmail.com $
 *  =======================================================================================
 */
    ...
    **************************************************************************************/
    public class LibStrings
    {
        ...
        *********************************************************************************/
        protected       static  final   char[]              LINEBREAK_CHARS             =
        {
            '\n', ' ', ',', '?', '-', ':', ';', '/', '.', '!'
        };
        ...
        *********************************************************************************************/
/*
        public static final void drawString( Canvas g, int col, Typeface fnt, LibAnchor anchor, String str, int x, int y )
        {
            drawString( g, col, null, null, fnt, anchor, str, x, y );
        }

        public static final void drawString( Graphics2D g, int colFg, int colShadow, int colOutline, Typeface fnt, LibAnchor anchor, String str, int aX, int aY )
        {
            int x            = aX;
            int y            = aY;
        ...
        public static final int getStringWidth( Canvas g, String str, Typeface fnt )
        {
            g.setFont( fnt );
        ...
        public static final int getStringHeight( Canvas g, Typeface fnt )
        {
            g.setFont( fnt );
            FontMetrics fm = g.getFontMetrics();
            return fm.getHeight();
...
*/
/*
        public static final String[] breakLinesOptimized( Graphics2D g2d, String aString, Typeface aFont, int aTargetWidth )
        {
            //avoid exceptions
        ...
        public static final void debugLineBreaks( Graphics2D g2d, LibDebug debug, Typeface font )
        {
        ...
        public static final int getLinesHeight( Graphics2D g, String[] lines, Typeface iFont, float lineSpacingRatioEmptyLines )
        {
            int iBlockHeight = 0;
        ...
        public static final void drawStrings( Graphics2D g, String[] lines, Typeface iFont, int aX, int aY, int fg, int shadow, int outline, float lineSpacingRatioEmptyLines )
        {
            int drawX       = aX;
            int drawY       = aY;
            int iLineHeight = LibStrings.getStringHeight( g, iFont );
